...
create table forma_pagamento (id bigint not null auto_increment, descricao varchar(30) not null, primary key (id)) engine=InnoDB;
create table grupo (id bigint not null auto_increment, nome varchar(255), primary key (id)) engine=InnoDB;
create table grupo_permissao (group_id bigint not null, permissao_id bigint not null) engine=InnoDB;
...
create table usuario (data_cadastro datetime, id bigint not null auto_increment, email varchar(255), nome varchar(255), senha varchar(255), primary key (id)) engine=InnoDB;
...
alter table grupo_permissao add constraint FK38ic6bw5t68msv1f56bk83nw foreign key (group_id) references grupo (id);
